...
export default function HeroSection() {
    const specialFeatures = ['No registeration needed', '24/7 Accessible', 'Download in seconds'];
    ...
    return (
        <section className='flex flex-col items-center justify-center px-4 md:px-16 lg:px-24'>
            ...
            <a href='https://resources.hirkaab.com' className='mt-32 flex items-center gap-2 rounded-full border border-gray-200 bg-gray-50 px-3 py-1 text-sm font-medium transition hover:bg-gray-100/80'>
                <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
                    ...
                    <defs>
                        <clipPath id='a'>
                            <path fill='#EF5324' d='M0 0h16v16H0z' />
                        </clipPath>
                    </defs>
                </svg>
                <p className='flex items-center gap-1'>
                    <span className='blue'>get unlimited digital resources</span>
                    <ChevronRight className='size-4 text-orange' />
                </p>
            </a>

            <h1 className='mt-4 max-w-3xl scale-105 bg-gradient-to-r from-[#5173c7] to-[#253C80] bg-clip-text text-center text-4xl/12 font-bold text-transparent md:scale-100 md:text-6xl/20'>Turn thoughts into Reality instantly with us.</h1>
            <p className='mt-2 max-w-xl text-center text-base/7 text-gray-700'>Effortlessly get premium resources for free and ready to use in seconds this is made possible by Hirkaab Academy Team.</p>

            <a href='/templates' className='mt-8 flex items-center gap-2 rounded-full bg-orange px-8 py-2.5 font-medium text-white transition hover:opacity-90'>
